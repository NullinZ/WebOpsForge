const RECOVERY_HINTS = {
  ...
  profile_busy: "This Chrome profile is already open outside WebOps Forge. To execute against this exact profile, reconnect it with CDP/extension control, or quit Chrome and let WebOps Forge launch the profile.",
